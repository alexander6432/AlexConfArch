  ...
  },
  {
    ...
    opts = function()
      ...
      local opts = {
        ...
        -- stylua: ignore
        center = {
          { action = 'lua LazyVim.pick()()',                           desc = " Explorador de Archivos", icon = " ", key = "f" },
          { action = "ene | startinsert",                              desc = " Nuevo Archivo",         icon = " ", key = "n" },
          { action = 'lua LazyVim.pick("oldfiles")()',                 desc = " Archivos Recientes",     icon = " ", key = "r" },
          { action = 'lua LazyVim.pick("live_grep")()',                desc = " Buscar por Palabra",     icon = " ", key = "g" },
          { action = 'lua LazyVim.pick.config_files()()',              desc = " Configuración",          icon = " ", key = "c" },
