...
local function setup(st, opts)
	...
	local styles = {
		[6] = t.modified and ui.Style(t.modified) or ui.Style():fg("#ef9f76"),
		[5] = t.added and ui.Style(t.added) or ui.Style():fg("#a6d189"),
		[4] = t.untracked and ui.Style(t.untracked) or ui.Style():fg("#f4b8e4"),
		[3] = t.ignored and ui.Style(t.ignored) or ui.Style():fg("#c6d0f5"),
		[2] = t.deleted and ui.Style(t.deleted) or ui.Style():fg("#e78284"),
		[1] = t.updated and ui.Style(t.updated) or ui.Style():fg("#8caaee"),
	}
	local signs = {
		...
		[1] = t.updated_sign and t.updated_sign or "󰏕",
	}
